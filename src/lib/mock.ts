  ...
  strengths: [
    {
      ...
      detail:
        "Very few studios globally combine cultural positioning with open-source tooling. Shilp Sutra as a public artifact makes Devalok philosophy visible and verifiable.",
    },
    {
  ...
  weaknesses: [
    {
      ...
      detail:
        "The website communicates identity well but does not yet convert — case studies, client outcomes, and social proof are sparse relative to the studio output.",
    },
    {
    ...
    },
    {
      ...
      detail:
        "The Bharat design space is unclaimed territory — Devalok is ideally placed to own it but has not yet made the flag-planting move on LinkedIn or X.",
    },
  ],
  recommendations: [
    {
      ...
      action:
        "Publish 3 detailed case studies showing strategy to design to outcome for past clients, with measurable results.",
      impact:
    ...
    },
    {
      ...
      area: "Messaging",
      action:
        "Create separate landing pages for each service line with tailored messaging per audience.",
      impact:
